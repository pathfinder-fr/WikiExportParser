// -----------------------------------------------------------------------
// <copyright file="MonsterParser.cs" organization="Pathfinder-Fr">
    ...
    public class MonsterParser
    {
        ...
        private CreatureType ParseType(string type)
        {
            switch (type.ToLowerInvariant())
            {
                ...
                case "créature artificielle":
                    return CreatureType.Construct;
                case "créature magique":
        ...
        private CreatureEnvironment ParseEnvironment(string environment)
        {
            ...
            {
                case "aquatique":
                    return CreatureEnvironment.Aquatic;
                case "ciel":
                    return CreatureEnvironment.Sky;
                case "collines":
                    return CreatureEnvironment.Hills;
                case "désert":
                    return CreatureEnvironment.Desert;
                case "forêt-jungle":
                    return CreatureEnvironment.ForestJungle;
                case "marais":
                    return CreatureEnvironment.Swamp;
                case "montagnes":
                    return CreatureEnvironment.Mountains;
                case "plaines":
                    return CreatureEnvironment.Plains;
                case "ruines-donjons":
                    return CreatureEnvironment.RuinsDungeons;
                case "souterrain":
                    return CreatureEnvironment.Underground;
                case "ville":
                    return CreatureEnvironment.Urban;
                case "":
        ...
        private CreatureClimate ParseClimate(string climate)
        {
            ...
            {
                case "extraplanaire":
                    return CreatureClimate.Planar;
                case "froid":
                    return CreatureClimate.Cold;
                case "tempéré":
                    return CreatureClimate.Temperate;
                case "tropical":
                    return CreatureClimate.Warm;
                case "":
