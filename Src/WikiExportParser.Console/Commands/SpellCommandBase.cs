namespace WikiExportParser.Commands
{
    ...
    public abstract class SpellCommandBase
    {
        ...
        protected List<Spell> ReadSpells()
        {
            ...
            WikiExportParser.Wiki.Parsing.Spells.DescriptionParser.ParseDescriptions(spells, spellLists, new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase), this.Log);
